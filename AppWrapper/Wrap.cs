...
namespace AppWrapper {
    public static class Wrap {
        ...
        public static void Run(Process currentProcess, string profileFile = ".J8WrapperProfile")
        {
            ...
            try {
                ...
                DebugLogger.WriteLine($">> FF8Path: {_profile.FF8Path}");
                ...
                foreach (var mod in _profile.Mods) {
                    foreach (string LA in mod.GetLoadAssemblies()) {
                        ...
                        try {
                            ...
                            asm.GetType("_JunctionVIII.Main")

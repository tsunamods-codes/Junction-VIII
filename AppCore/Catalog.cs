...
namespace Iros.Workshop
{
    ...
    public enum LocationType
    {
        ...
        GDrive,
        ExternalUrl // iroj://ExternalUrl/{url} where {url} can be left blank and it assumes the previous url in the list
    }
    ...
    public static class LocationUtil
    {
        ...
        {
            if (link.StartsWith("iroj://", StringComparison.InvariantCultureIgnoreCase)) link = link.Substring(7);
        ...
        public static string FormatHttpUrl(string httpUrl)
        {
            ...
            // already formatted
            if (httpUrl.StartsWith("iroj://Url/"))
            {
                return httpUrl;
            }

            return "iroj://Url/" + httpUrl.Replace("://", "$");
        }
    }

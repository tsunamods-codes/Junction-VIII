    ...
    public class ControlMappingViewModel : ViewModelBase
    {
        ...
        internal void UpdateAllButtonIcons()
        {
            Dictionary<GameControl, string> propertiesToUpdate = new Dictionary<GameControl, string>()
            {
                ...
                { GameControl.Exit, nameof(CancelIcon) },
                { GameControl.Misc, nameof(SwitchIcon) },
                { GameControl.Menu, nameof(MenuIcon) },
                { GameControl.Toggle, nameof(PageUpIcon) },
                { GameControl.Trigger, nameof(PageDownIcon) },
                { GameControl.RotLt, nameof(CameraIcon) },
                { GameControl.RotRt, nameof(TargetIcon) },
                { GameControl.Start, nameof(StartIcon) },
                { GameControl.Select, nameof(AssistIcon) },
        ...
        private void UpdateButtonText(GameControl controlToUpdate)
        {
            Dictionary<GameControl, string> propertiesToUpdate = new Dictionary<GameControl, string>()
            {
                ...
                { GameControl.Exit, nameof(CancelKeyboardText) },
                { GameControl.Misc, nameof(SwitchKeyboardText) },
                { GameControl.Menu, nameof(MenuKeyboardText) },
                { GameControl.Toggle, nameof(PageUpKeyboardText) },
                { GameControl.Trigger, nameof(PageDownKeyboardText) },
                { GameControl.RotLt, nameof(CameraKeyboardText) },
                { GameControl.RotRt, nameof(TargetKeyboardText) },
                { GameControl.Start, nameof(StartKeyboardText) },
                { GameControl.Select, nameof(AssistKeyboardText) },
            ...
            Dictionary<GameControl, string> gamepadpropertiesToUpdate = new Dictionary<GameControl, string>()
            {
                ...
                { GameControl.Exit, nameof(CancelControllerText) },
                { GameControl.Misc, nameof(SwitchControllerText) },
                { GameControl.Menu, nameof(MenuControllerText) },
                { GameControl.Toggle, nameof(PageUpControllerText) },
                { GameControl.Trigger, nameof(PageDownControllerText) },
                { GameControl.RotLt, nameof(CameraControllerText) },
                { GameControl.RotRt, nameof(TargetControllerText) },
                { GameControl.Start, nameof(StartControllerText) },
                { GameControl.Select, nameof(AssistControllerText) },
        ...
        /// <summary>
        /// Copies ff8input.cfg from FF8 game folder to ./Resources/Controls/ folder with the given <paramref name="customFileName"/>
        /// </summary>
        /// <param name="forceCopy"> copies ff8input.cfg if it already exists; overwriting the current custom.cfg </param>
        public bool CopyInputCfgToCustomCfg(bool forceCopy, string customFileName)
        {
            ...
            if (!File.Exists(pathToCustomCfg) || forceCopy)
            {
                if (File.Exists(pathToInputCfg))
                {
                    ...
                    {
                        Logger.Error(ex);
                        //StatusMessage = $"{ResourceHelper.Get(StringKey.ErrorCopyingFf8InputCfg)} {ex.Message}";
                    }
                }
                else
                {
                    //StatusMessage = $"{ResourceHelper.Get(StringKey.NoFf8InputCfgFoundAt)} {pathToInputCfg}";
        ...
        private void SetButtonIcon(string propertyToUpdate, GamePadButton? newButton)
        {
            ...
            {
                { GamePadButton.Button1, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/Square_X.png" },
                { GamePadButton.Button2, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/Cross_A.png" },
                { GamePadButton.Button3, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/Circle_B.png" },
                { GamePadButton.Button4, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/Triangle_Y.png" },
                { GamePadButton.Button5, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/L1_LB.png" },
                { GamePadButton.Button6, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/R1_RB.png" },
                { GamePadButton.Button7, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/L2_LT.png" },
                { GamePadButton.Button8, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/R2_RT.png" },
                { GamePadButton.Button9, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/Share_Back.png" },
                ...
                { GamePadButton.Button14, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/Unknown.png" },
                ...
                { GamePadButton.Right, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/XB_LS_Right.png" },
                { GamePadButton.DPadUp, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/XBOne_DPad_Up.png" },
                { GamePadButton.DPadDown, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/XBOne_DPad_Down.png" },
                { GamePadButton.DPadLeft, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/XBOne_DPad_Left.png" },
                { GamePadButton.DPadRight, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/XBOne_DPad_Right.png" },
            };

            Dictionary<GamePadButton, string> directionalIcons = new Dictionary<GamePadButton, string>()
            {
                { GamePadButton.Up, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/LS_DPad_Up.png" },
                { GamePadButton.Down, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/LS_DPad_Down.png" },
                { GamePadButton.Left, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/LS_DPad_Left.png" },
                { GamePadButton.Right, "/Junction VIII;component/Resources/Icons/PS_Xbox_Icons/LS_DPad_Right.png" },
            };
